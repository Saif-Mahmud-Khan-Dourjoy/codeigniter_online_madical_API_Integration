...
<head>
    ...
    <link rel="icon" href="https://callncure.com/public/assets/img/favicon.png">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://callncure.com/public/assets/css/bootstrap.min.css">
    <!-- animate CSS -->
    <link rel="stylesheet" href="https://callncure.com/public/assets/css/animate.css">
    <!-- owl carousel CSS -->
    <link rel="stylesheet" href="https://callncure.com/public/assets/css/owl.carousel.min.css">
    <!-- themify CSS -->
    <link rel="stylesheet" href="https://callncure.com/public/assets/css/themify-icons.css">
    <!-- flaticon CSS -->
    <link rel="stylesheet" href="https://callncure.com/public/assets/css/flaticon.css">
    <!-- magnific popup CSS -->
    <link rel="stylesheet" href="https://callncure.com/public/assets/css/magnific-popup.css">
    <!-- nice select CSS -->
    <link rel="stylesheet" href="https://callncure.com/public/assets/css/nice-select.css">
    <!-- swiper CSS -->
    <link rel="stylesheet" href="https://callncure.com/public/assets/css/slick.css">
    <!-- style CSS -->
    <link rel="stylesheet" href="https://callncure.com/public/assets/css/style.css">

    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="https://callncure.com/public/assets/vendor/animate/animate.css">
    <link rel="stylesheet" type="text/css" href="https://callncure.com/public/assets/vendor/css-hamburgers/hamburgers.min.css">
    <link rel="stylesheet" type="text/css" href="https://callncure.com/public/assets/vendor/select2/select2.min.css">
    <link rel="stylesheet" type="text/css" href="https://callncure.com/public/assets/css/util.css">
    <link rel="stylesheet" type="text/css" href="https://callncure.com/public/assets/css/main.css">
...
<body>
            ...
            <div class="row align-items-center">
                <div class="col-lg-12">
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <a class="navbar-brand" href="index.html"> <img src="https://callncure.com/public/assets/img/callncure-logo.png" alt="logo"> </a>
            ...
            <div class="container">
                <div class="row justify-content-between">
                    <div class="col-xl-2 col-md-4 col-sm-6 single-footer-widget">
                        <a href="#" class="footer_logo"> <img src="https://callncure.com/public/assets/img/callncure-logo.png" alt="#"> </a>
    ...
    <script src="https://callncure.com/public/assets/js/jquery-1.12.1.min.js"></script>
    <!-- popper js -->
    <script src="https://callncure.com/public/assets/js/popper.min.js"></script>
    <!-- bootstrap js -->
    <script src="https://callncure.com/public/assets/js/bootstrap.min.js"></script>
    <!-- owl carousel js -->
    <script src="https://callncure.com/public/assets/js/owl.carousel.min.js"></script>
    <script src="https://callncure.com/public/assets/js/jquery.nice-select.min.js"></script>
    <!-- contact js -->
    <script src="https://callncure.com/public/assets/js/jquery.ajaxchimp.min.js"></script>
    <script src="https://callncure.com/public/assets/js/jquery.form.js"></script>
    <script src="https://callncure.com/public/assets/js/jquery.validate.min.js"></script>
    <script src="https://callncure.com/public/assets/js/mail-script.js"></script>
    <script src="https://callncure.com/public/assets/js/contact.js"></script>
    <!-- custom js -->
    <script src="https://callncure.com/public/assets/js/custom.js"></script>

    <!--===============================================================================================-->
    <script src="https://callncure.com/public/assets/vendor/select2/select2.min.js"></script>
    <script src="https://callncure.com/public/assets/vendor/tilt/tilt.jquery.min.js"></script>
    <script>
        $('.js-tilt').tilt({
            scale: 1.1
        })
    </script>
    <script src="https://callncure.com/public/assets/js/main.js"></script>

<!-- Main js all common file include -->
<script src="https://callncure.com/public/rtc/doctorcustom.js"></script>
<script src="https://callncure.com/public/rtc/live_webrtc/dist/RTCMultiConnection.js"></script>
<script src="https://callncure.com/public/rtc/live_webrtc/node_modules/webrtc-adapter/out/adapter.js"></script>
<script src="https://rtcmulticonnection.herokuapp.com/socket.io/socket.io.js"></script>

<!-- custom layout for HTML5 audio/video elements -->
<link rel="stylesheet" href="https://callncure.com/public/rtc/live_webrtc/dev/getHTMLMediaElement.css">
<script src="https://callncure.com/public/rtc/live_webrtc/dev/getHTMLMediaElement.js"></script>
<script src="https://callncure.com/public/rtc/live_webrtc/node_modules/recordrtc/RecordRTC.js"></script>
<script src="https://callncure.com/public/rtc/live_webrtc/rtc_main.js"></script>
  ...
  <script>
      var url=window.location.href;
        ...
        $.ajax({
               url: "https://callncure.com/api/video/get_details/",
               type: "POST",
               dataType: 'json',
               data : {
                    'room_id' : room_id,
...
//            $.ajax({
//             type  : 'GET',
//             url : 'https://callncure.com/api/video/open_video',
//             async : false,
//             dataType : 'json',
...
<script>
    $(document).ready(function(){
     ...
     $('#save').click(function(){
      ...
      $.ajax({
       url:"https://callncure.com/api/Prescriptions/prescription",
       method:"POST",
       data:{
