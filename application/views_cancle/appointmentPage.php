...
<body>
        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    ...
                    <form class="login100-form validate-form" id="form_appointment" method="post">
                        <span class="login100-form-title">
					 Appointment Ready করুন 
					</span>
                         ...
                         <div class="wrap-input100 validate-input" data-validate="সঠিক AGE দিতে হবে">
                            <input class="input100" type="number" name="age" id="age" placeholder="আপনার AGE">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                            <!-- <i class="fa fa-envelope" aria-hidden="true"></i> -->
                        </span>
                        </div>
                         <div class="wrap-input100 validate-input" data-validate="সঠিক Date দিতে হবে">
                            <input class="input100" type="date" name="date" id="date" placeholder="SPECIALIZED IN">
                            <span class="focus-input100"></span>
                            <span class="symbol-input100">
                            <!-- <i class="fa fa-envelope" aria-hidden="true"></i> -->
                        </span>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            var doc_id = url.substring(url.lastIndexOf('=') + 1);
            ...
            // return false;
               ...
               $.ajax({
            url: "<?php echo base_url();?>ControllerAppointment/getAppointment",
            type: "POST",
            // dataType: 'json',
            data : {
                 'name' : name,
            ...
            success:function(data){
                ...
                if(data==1){
                   ...
                   swal({
                          ...
                          text: "Congratulations Appointment is Successfull and you are invited in the date of! " + date,
                          timer: 3000
                        });
                    setTimeout(function(){
                    location.reload();
                     ...
                     swal("Appointment Successfully not Done!");
                }   
            }
            }); 
        });
